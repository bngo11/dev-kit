...
SRC_URI="
	...
	test? ( https://api.github.com/repos/nlohmann/json_test_data/tarball/v3.2.0 -> json_test_data-3.2.0.tar.gz )
"
...
fix_src_dirs() {
	...
	mv nlohmann-json_test_data-* json_test_data-3.2.0
	popd
}
...
src_configure() {
	...
	use test && mycmakeargs+=( -DJSON_TestDataDirectory="${WORKDIR}"/json_test_data-3.2.0 )
