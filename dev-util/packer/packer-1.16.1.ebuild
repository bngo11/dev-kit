...
EGO_SUM=(
	...
	"cloud.google.com/go/monitoring v1.25.0/go.mod"
	...
	"github.com/!azure!a!d/microsoft-authentication-library-for-go v1.7.0"
	"github.com/!azure!a!d/microsoft-authentication-library-for-go v1.7.0/go.mod"
	...
	"github.com/!google!cloud!platform/opentelemetry-operations-go/detectors/gcp v1.33.0/go.mod"
	...
	"github.com/!microsoft/go-winio v0.6.3-0.20251027160822-ad3df93bed29/go.mod"
	"github.com/!microsoft/hcsshim v0.15.0-rc.1"
	"github.com/!microsoft/hcsshim v0.15.0-rc.1/go.mod"
	...
	"github.com/containerd/platforms v1.0.0-rc.5/go.mod"
	"github.com/containerd/plugin v1.1.0"
	"github.com/containerd/plugin v1.1.0/go.mod"
	...
	"github.com/erofs/go-erofs v0.3.0/go.mod"
	...
	"github.com/google/go-github/v75 v75.0.0/go.mod"
	...
	"github.com/hashicorp/go-checkpoint v0.5.1-0.20260522084958-784cec078f5b/go.mod"
	...
	"github.com/hashicorp/go-cty-funcs v0.1.1-0.20260703063543-3af2ddd1aaea/go.mod"
	...
	"github.com/hashicorp/go-getter/v2 v2.2.4/go.mod"
	...
	"github.com/hashicorp/hcp-sdk-go v0.175.0/go.mod"
	...
	"github.com/hashicorp/packer-plugin-sdk v0.6.11/go.mod"
	...
	"github.com/shoenig/go-m1cpu v0.2.2/go.mod"
	...
	"github.com/spiffe/go-spiffe/v2 v2.7.0/go.mod"
	...
	"github.com/theupdateframework/go-tuf/v2 v2.4.2-0.20260407074541-7e8f69f906ef/go.mod"
	...
	"go.opentelemetry.io/contrib/detectors/gcp v1.44.0/go.mod"
...
SRC_URI="https://github.com/hashicorp/packer/tarball/8d3617fc870d5f08a598806a43d49ed6ee4d08ab -> packer-1.16.1-8d3617f.tar.gz
https://direct.funtoo.org/b3/a4/4e/b3a44e6d9d207860eba38a24a1ed7ce5a6db3062c6c12caf425b0967f20049827f1df4839b5fd43a0bd9b25786c5f1921ee40a9d5920faf35b0eeb5a6f1c888c -> packer-1.16.1-funtoo-go-bundle-19976d76418e1fa1c8216189b6b1d49e5aa1a67590e06ac393e5849e63b30ee7b681ccb380f88ad9a862fb2c92d09fa0d59fccaf895b4482b2d361a3af2282a3.tar.gz"
...
S="${WORKDIR}/hashicorp-packer-8d3617f"
