...
SRC_URI="amd64? (
  https://github.com/WebAssembly/binaryen/releases/download/version_128/binaryen-version_128-x86_64-linux.tar.gz -> binaryen-version_128-x86_64-linux.tar.gz
)
arm64? (
  https://github.com/WebAssembly/binaryen/releases/download/version_128/binaryen-version_128-aarch64-linux.tar.gz -> binaryen-version_128-aarch64-linux.tar.gz
)
"
