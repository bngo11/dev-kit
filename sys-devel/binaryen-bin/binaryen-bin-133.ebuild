...
SRC_URI="amd64? (
  https://github.com/WebAssembly/binaryen/releases/download/version_133/binaryen-version_133-x86_64-linux.tar.gz -> binaryen-version_133-x86_64-linux.tar.gz
)
arm64? (
  https://github.com/WebAssembly/binaryen/releases/download/version_133/binaryen-version_133-aarch64-linux.tar.gz -> binaryen-version_133-aarch64-linux.tar.gz
)
"
